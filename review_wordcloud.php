...
thead tr{position: absolute; margin-top:-45px}
  ...
  <body>
	...
	<div>
	<form action="review_wordcloud.php" method="post" name="product">
	...
	<div style="float:right; width:25%;">
	  <button type="submit" action="review_wordcloud.php" class="btn btn-info" onclick="set_product();" >워드 클라우드 보기<i class="fa fa-check spaceLeft"></i></button>
            </div>  
	</form>
	</div>     
        </div>
	...
	<table class="table">
			<thead><tr>
				<th style="font-size:20px;">긍정적 워드 클라우드</th>
			</tr></thead>
	<?php
		if($product){
			$product=str_replace(' ','_',$product);
			$pro_pos="/".$product."/".$product."_positive.png";
			echo "<tr>";
			echo "<td align='center'><img src=$pro_pos></img></td>";
			echo "</tr>";
		}
	?>
	</table>
	...
	<table class="table table-striped">
			<thead><tr>
				<th style="font-size:20px;">부정적 워드 클라우드</th>
			</tr></thead>
	<?php
		if($product){
			$product=str_replace(' ','_',$product);
			$pro_neg="/".$product."/".$product."_negative.png";
			echo "<tr>";
			echo "<td align='center'><img src=$pro_neg></img></td>";
			echo "</tr>";
		}
	?>
	</table>
