  ...
  <body>
    ...
    <div class="menubar">
      <ul>
        ...
        <li><a href="review_crawl.php">리뷰 검색</a></li>
	...
	<div style="float:right; width:25%;">
	  <button type="submit" action="review_crawl.php" class="btn btn-info" onclick="search_link();">리뷰 검색<i class="fa fa-check 	spaceLeft"></i></button>
            </div>  
	</div>               
          </form>
	<div>
	<form action="review_crawl.php" method="post" name="product">
            <div class="form-group" style="float:left; width:75%;">
	...
	<div style="float:right; width:25%;">
	  <button type="submit" action="review_crawl.php" class="btn btn-info" onclick="set_product();" >리뷰 보기<i class="fa fa-check 	spaceLeft"></i></button>
            </div>  
	</form>
	</div>     
        </div>
